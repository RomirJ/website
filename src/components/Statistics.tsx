    ...
    <section className="py-24 bg-gradient-to-b from-slate-50 to-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6 hover:scale-105 transition-transform duration-500">
        ...
        <div className="mt-16 text-center animate-fade-in" style={{animationDelay: '800ms'}}>
          <div className="bg-gradient-to-r from-emerald-50 to-green-50 border border-emerald-200 rounded-2xl p-8 max-w-3xl mx-auto hover:scale-105 transition-transform duration-500">
            ...
            <div className="flex items-center justify-center space-x-4">
              <div className="w-12 h-12 rounded-full overflow-hidden bg-white p-1 hover:scale-110 transition-transform duration-300">
                <img 
