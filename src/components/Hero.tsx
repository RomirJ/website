          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8 animate-fade-in [animation-delay:600ms]">
              ...
              <Button 
                size="lg" 
                variant="outline" 
                className="border-slate-500 bg-slate-800/30 text-slate-200 hover:bg-slate-700 hover:text-white hover:border-slate-400 h-16 text-lg font-semibold group transition-all duration-300 hover:scale-105"
